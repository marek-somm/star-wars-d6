...
export const powersOld = {
	...
	skills: [
		...
		},
		{
			...
			powers: ['alter'],
			extra: [data.extra.keptUp + ' as long as the source of energy is constant — for blaster bolts or Force lightning, it is used as a reaction skill, multiple action penalties apply for use to block fire (as though it were a dodge skill)'],
			difficulty: {
				alter: {
					level: [
						{
		...
		},
		{
			...
			extra: [data.extra.notUsableWhenDarkside],
			difficulty: {
				control: {
					level: [
						{
		...
		},
		{
			name: 'Farseeing',
			powers: ['control', 'sense'],
			timeToUse: data.time.minute_plus,
			requires: ['Life Sense'],
			difficulty: {
				control: {
					level: [
